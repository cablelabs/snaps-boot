...
| post_script_url | N | URL for automated post install script that can be downloaded via HTTP. This machine specific attribute will override the global post install script attribute.|
...
| post_script_location | N | Local file location of a global post install script, e.g., /var/log/post_script. Note: This global attribute will be overriden by server specific post_script_url attribute if specified. |
