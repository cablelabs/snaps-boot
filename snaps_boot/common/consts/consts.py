...
DEVSTACK_YAML = ANSIBLE_PATH \
                + "commission/openstack/playbooks/deploy_mode/devstack/"
OPENSTACK = "openstack"
...
MULTI_NODE_KOLLA_COMPUTE_YAML = KOLLA_YAML \
                                + "multinode_kolla_compute_newton.yaml"
MULTI_NODE_KOLLA_ISO_NWK_YAML = KOLLA_YAML \
                                + "multinode_kolla_iso_network.yaml"
MULTI_NODE_KOLLA_CONTROLLER_YAML = KOLLA_YAML \
                                   + "multinode_kolla_controller_newton.yaml"
